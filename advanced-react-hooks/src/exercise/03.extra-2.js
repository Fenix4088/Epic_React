...
export const PokemonCacheProvider = ({children, props}) => {
  const pokemonCache = React.useReducer(pokemonCacheReducer, {})
  return (
    <PokemonCacheContext.Provider value={pokemonCache} {...props}>
      {children}
...
export const usePokemonCache = () => {
  ...
  if (!context)
    throw new Error(`usePokemonCache can not use without PokemonCacheProvider`)
